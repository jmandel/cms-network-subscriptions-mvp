...
export const sources: SourceFixture[] = [
  {
    ...
    patientId: "data-holder-patient-valley",
  },
  {
    id: "mercy",
    ...
    supportsQuery: true,
    supportsFeed: true,
    endpoint: "https://network.example.org/fhir/data-holders/mercy",
    patientId: "data-holder-patient-mercy",
  },
  {
    id: "northside",
    ...
    patientId: "data-holder-patient-northside",
  },
];
        ...
        Encounter: [
          {
            ...
            subject: { reference: "Patient/data-holder-patient-valley" },
        ...
        Appointment: [
          {
            ...
            participant: [{ actor: { reference: "Patient/data-holder-patient-valley" } }],
        ...
        Encounter: [
          {
            ...
            subject: { reference: "Patient/data-holder-patient-mercy" },
        ...
        Encounter: [
          {
            ...
            status: "finished",
            class: { code: "AMB", display: "ambulatory" },
            subject: { reference: "Patient/data-holder-patient-northside" },
